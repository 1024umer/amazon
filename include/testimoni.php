<section class="testimonial-sec-v2 pt-120 pb-4">
        <div class="container">
            <div class="row g-0">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="testimonials-inner-v2">
                        <img src="images/testi-map.png" class="main-maps" alt="">
                        <div class="testimonial-single-v2 one">
                            <div class="imgs">

...
<a href="tel:+888-918-0661" class="callusnow">READY? CLICK TO CALL</a>
         ...
         <div class="container">
            <div class="row ">
               <div class="col-md-8 col-12">
                  ...
                  <h3 class="banner-heading" data-aos="fade-right"><span>Our Intelligently Tailored Made </span>Book Marketing Services<br> <span>For Your</span> Book Promotion</h3>
                        ...
                        <div class="banner-form-form" data-aos="fade-down">
                           <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <textarea name="message" type="text" class="form-control" placeholder="Enter Your Message" ></textarea>
                              </div>
                           </div>
      ...
      <section class="book-marketing sec-padding">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-7">
                  <h2 class="sec-heading" data-aos="fade-down">#1 Book Marketing And<br> Promotion Company </h2>
                  <p class="sec-para" data-aos="fade-left">Our marketing team comes up with innovative book marketing strategies and plans to get more people to read your book. Of course, the world must know about the launch of your eccentric book, and that’s what we are here for – to let them know.<br>
                     We will create a marketing and promotional campaign for your book that will turn heads when published. The goal is to reach out to anyone interested in the genre of your novel. For your book, a targeted promotional strategy and action plan will be developed. Cutting-edge digital marketing strategies can be used to reach out to the intended audience.
                  </p>
                     ...
                     <div class="col-lg-4 col-md-12">
                        <div class="counters">
                           <div class="counter custom-sm-counter-style">
                              ...
                              <h6 class="text-center">Satisfied Clients</h6>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
      ...
      <section class="client-reviews sec-padding">
         <div class="container">
            <h2 class="sec-heading" data-aos="fade-down">Why Clients All Over The World <br>Choose Amazon Publication Experts </h2>
            <p class="sec-para" data-aos="fade-up">At Amazon Publication Experts, we understand what is required to successfully execute flawless marketing strategies which resultant in making the client's books best-sellers</p>
               ...
               <div class="col-lg-3" data-aos="fade-down">
                  <div class="featured-box text-center">
                     <div class="intro-header">
                        ...
                        <h2>A Well-Thought-Out <br> Marketing Strategy</h2>
                     </div>
                     <div class="content">
                        <p>Each book is different, which is why we can customize your book marketing promotions to fit your individual needs when you ask us to help you out.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3" data-aos="fade-up">
                  <div class="featured-box text-center">
                     <div class="intro-header">
                        ...
                        <h2>A Customized <br> Approach To Your <br>Promotional Needs</h2>
                     </div>
                     <div class="content">
                        <p>We offer a number of marketing services to promote your book so that you always know what is happening. With an entire team dedicated to your book, you can expect a lot of success.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3" data-aos="fade-down">
                  <div class="featured-box text-center">
                     <div class="intro-header">
                        ...
                        <h2>Target Audience <br> Research</h2>
                     </div>
                     <div class="content">
                        <p>We at Amazon Publication Experts specialize in in-depth research that can help you choose the best target audience for your book. With the help of research, people who love the genre you write in will see your advertisements, which will boost your sales.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3" data-aos="fade-up">
                  <div class="featured-box text-center">
                     <div class="intro-header">
                        ...
                        <h2>Round The <br> Clock Support </h2>
                     </div>
                     <div class="content">
                        <p>Our support team is available 24/7 to assist you in your book marketing process and strives to deliver you a suitable and flawless marketing strategy and support services.</p>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-7 col-md-8 cta-wrapper">
                  <h2 class="sec-heading" data-aos="fade-left">#1 Book Marketing Company </h2>
      ...
      <section class="how-it-works sec-padding">
         <div class="container">
            <h2 class="sec-heading" data-aos="fade-down">How It Works</h2>
            <p class="sec-para" data-aos="fade-up">Based on the information you provide and our own market research, we create a detailed book marketing plan. After the <br>marketing plan and roadmap are finalized, we begin marketing activities and monitor results continuously.</p>
            <div class="row how-it-slider">
               <div class="col-md-4 work-box-wrapper" data-aos="fade-right">
                  <h2 class="box-number">1</h2>
                  <h5>Discovery Calls</h5>
                  <p>Fill out a simple form to reserve your spot and provide all relevant information about your book. Our project managers will be in touch with you immediately. Your order will be confirmed once the manager has received all the necessary information.</p>
               </div>
               <div class="col-md-4 work-box-wrapper" data-aos="fade-left">
                  <h2 class="box-number">2</h2>
                  <h5>Research & Determining Target Audience</h5>
                  <p>Marketing strategies for your book will be drafted by the most qualified marketers. After conducting thorough research on the topic of your book, the target audience will be determined, and the book will be marketed so as to reach that audience.</p>
               </div>
               <div class="col-md-4 work-box-wrapper" data-aos="fade-up">
                  <h2 class="box-number">3</h2>
                  <h5>First Marketing Strategy Approval</h5>
                  <p>The first marketing step is sent to you for your approval as soon as it is drawn up. Once approved, the execution of marketing strategies similarly begins.</p>
               </div>
               <div class="col-md-4 work-box-wrapper" data-aos="fade-down">
                  <h2 class="box-number">4</h2>
                  <h5>Pre-launch Promotion</h5>
                  <p>We will create buzz and hype about your book even before you publish it. We do this by appealing posts, opening pre-bookings, and self-advertising in top newspapers and magazines.</p>
               </div>
               <div class="col-md-4 work-box-wrapper" data-aos="fade-left">
                  <h2 class="box-number">5</h2>
                  <h5>Book Launch</h5>
                  <p>We know how to plan your perfect book launch, to invite the key players who will play a pivotal role in building public relations as well as hiring media people to help you market your book.</p>
               </div>
               <div class="col-md-4 work-box-wrapper" data-aos="fade-right">
                  <h2 class="box-number">6</h2>
                  <h5>Post-Launch Promotion</h5>
                  <p>The marketing campaign will not end once your book is published. It is a crucial point in determining the success of your book and they will execute more promotional plans until your book becomes a bestseller.</p>
               </div>
            </div>
         </div>
      </section>
